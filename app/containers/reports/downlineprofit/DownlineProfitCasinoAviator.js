...
function DownlineProfitCasinoAviator() {
          ...
          <Link
            to={
              params.row.user_type == 'MASTER'
                ? `/report/downline-profit-casino-aviator-user/${params.row.path}/${params.row.user_type}`
...
export default DownlineProfitCasinoAviator;
