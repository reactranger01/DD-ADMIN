...
function BetListUser() {
  ...
  const columns = [
    ...
    { headerName: 'Event', field: 'event', width: 250, minWidth: 200, flex: 1 },
    {
      headerName: 'Market',
      field: 'market',
      width: 100,
    ...
    { headerName: 'Stake', field: 'stake', width: 70, minWidth: 70, flex: 1 },
    {
      headerName: 'Win/Loss',
      field: 'status',
      width: 90,
  ...
  return (
    <>
      ...
      <div>
        ...
        <div className="mx-4 mt-4 border border-gray-500 rounded-md h-full ">
