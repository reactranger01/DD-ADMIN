...
function ProfileUserAviator() {
  ...
  return (
    <div className=" bg-white border rounded-sm shadow-md">
              ...
              <div className="grid grid-cols-5">
                ...
                <div className="relative col-start-2 col-end-5">
                  <input
                    ...
                    id="username"
                    className="shadow-sm rounded-md px-3 py-1 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 w-full"
                  />
                  <button
                    type="button"
                    onClick={toggleVisibility}
                    className="absolute inset-y-0 right-5 px-3  bg-transparent border-none text-gray-500"
                  >
                    {showPassword ? (
      ...
      <div className="font-bold p-1 text-sm h-8 bg-[#071535] w-full rounded-t-md ">
        <h7 className="p-1">Account Details </h7>
      </div>
...
export default ProfileUserAviator;
