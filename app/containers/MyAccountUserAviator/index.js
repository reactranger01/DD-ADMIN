...
function MyAccountUserAviator() {
  const location = useLocation();
  // Accessing id from location.state
  const { id } = useParams();
  ...
  const linkData = [
    {
      path: `/user_account_aviator/${userid}`,
      title: 'My Profile',
    },
    {
      path: `/user_account_aviator/${userid}/bet_history`,
      title: 'Bet History',
    },
    {
      path: `/user_account_aviator/${userid}/profit_lose`,
      title: 'Profit & Loss',
    },
    {
      path: `/user_account_aviator/${userid}/account_statement`,
      title: 'Account Statement',
    },
    {
      path: `/user_account_aviator/${userid}/activity_log`,
      title: 'Activity Log',
    },
  ];
  return (
...
export default MyAccountUserAviator;
