      ...
      <div className="right-side col-start-8 col-end-13  text-sm font-bold">
        ...
        <div className=" mb-2 rounded-t">
          <div
            ...
            onClick={liveTennisClicked}
          >
            <span> Score Card</span>
            <button
              onClick={liveTennisClicked}
              className="bg-[#27c449] flex p-0.5 rounded gap-1.5 items-center ml-auto w-auto "
            >
              <img
          ...
          <div
            className={`w-full md:p-1 p-0  mt-0 shadow-md ${
              isClickedLive ? '' : 'hidden'
            }`}
          >
            <iframe
              src={`https://diamondapi.uk/dcasino/sr.php?eventid=${eventId}&sportid=2`}
              title="description"
