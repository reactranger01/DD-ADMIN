...
const MasterBook = ({ isopenMasterBook, handlecloseMasterBook }) => {
  const [isopenMasterBookchild, setUserBookchild] = useState(false);
  const handleMasterchild = () => {
  ...
  return (
    <div>
        ...
        <div className="relative  w-full max-w-3xl mx-auto shadow-md rounded-b-lg bg-white px-8 py-4">
          <div className=" border border-slate-400">
            <div className="flex font-bold text-sm p-2 text-[#000000]">
              <h4 onClick={handleMasterchild} className="cursor-pointer">
                Bookmaker IPL CUP
              </h4>
            </div>
          </div>
      ...
      <MasterBookList
        isopenMasterBookchild={isopenMasterBookchild}
