...
const MasterBookchild = ({
  isopenMasterBookchild,
  handlecloseMasterBookchild,
}) => {
  return (
    <div>
      <div
      ...
      >
        <div className="text-sm text-white  text-center h-4 rounded-t-lg bg-[#040B1D] relative w-full max-w-lg mx-auto shadow-md px-8 py-4 row flex justify-between items-center">
          ...
          <button className=" flex-none">
            <RxCross2
              className="h-4 w-4 "
              onClick={handlecloseMasterBookchild}
            />
          </button>
        </div>
...
MasterBookchild.propTypes = {
  isopenMasterBookchild: PropTypes.bool.isRequired,
  handlecloseMasterBookchild: PropTypes.func.isRequired,
};

export default MasterBookchild;
