...
function ActivityLogMaster() {
  ...
  return (
    <>
      {isLoading && <Loading />}
      <div className=" border border-gray-500 rounded-md h-full ">
        <div className="h-8 bg-[#071535]  text-sm rounded-t-md font-semibold">
...
export default ActivityLogMaster;
