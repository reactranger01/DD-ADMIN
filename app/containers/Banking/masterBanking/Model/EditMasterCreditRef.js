...
const EditMasterCreditRef = ({ handleCloseMaster, isOpenMasterCreditref }) => {
  return (
    <div
      className={
        isOpenMasterCreditref
    ...
    >
      <div className="text-sm text-center h-4 rounded-t-md bg-[#071535] relative w-full max-w-lg mx-auto shadow-md px-8 py-4 row  flex justify-between  text-white">
        <h4 className="mt-[-0.5rem] text-sm font-bold">
          Edit Credit Reference - rahulking34
        </h4>
      ...
      <div className="relative w-full max-w-lg mx-auto shadow-md rounded-b-lg bg-white px-4 py-4 ">
        <div className="grid grid-cols-1 gap-3 my-4">
          <div className="text-gray-700 grid grid-cols-5">
            <label
              htmlFor="username"
              className="text-gray-700 font-medium mb-2 col-start-1 col-end-2  rtl:text-right"
            >
              Current
            </label>
          ...
          <div className="flex flex-row-reverse gap-2 text-sm font-bold">
...
EditMasterCreditRef.propTypes = {
  isOpenMasterCreditref: PropTypes.bool.isRequired,
  handleCloseMaster: PropTypes.func.isRequired,
};
export default EditMasterCreditRef;
