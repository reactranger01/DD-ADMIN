...

    {
      ...
      renderCell: (params) => (
        ...
        >
          ...
          >
            {numberWithCommas(Math.abs(parseInt(params.row.userPoints))) || 0}
          </h6>
        </div>
      ),
    },
      ...
      renderCell: (params) => (
        ...
        >
          <input
            ...
            placeholder="Remark"
            className="w-32 h-8 px-1 border border-gray-300 rounded-sm"
          />
        </div>
      ),
    },
    ...
    <>
      ...
      <div className="mx-2  md:mx-10 my-4 border border-gray-300 rounded-lg   h-full border-solid borderflex  text-sm text-slate-950">
        ...
        <div className=" w-auto flex items-center my-6">
          ...
          <div className="lg:w-64 md:w-40 bg-slate-700  rounded-md mx-6 content-center h-9">
            {isLoading ? (
