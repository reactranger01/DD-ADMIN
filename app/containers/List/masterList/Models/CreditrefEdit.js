...
function CreditrefEdit({ isOpencredit, handleClosecredit }) {
  return (
    <div>
      <div
        className={
      ...
      >
        <div className="text-sm text-white font-bold text-center h-4 rounded-t-lg bg-[#071535] relative w-full max-w-lg mx-auto shadow-md px-8 py-4 row flex">
          <h4 className="mt-[-0.5rem] grow text-left">
            Edit Credit Reference - aakashkishan
          </h4>
...
CreditrefEdit.propTypes = {
  isOpencredit: PropTypes.bool.isRequired,
  handleClosecredit: PropTypes.func.isRequired,
};

export default CreditrefEdit;
