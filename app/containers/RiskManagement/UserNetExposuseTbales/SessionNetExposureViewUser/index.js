...
import SessionNetExposureTableUser from '@/components/TablesUser/SessionNetExposureTableUser';

const SessionNetExposureViewUser = () => {
  ...
  return (
    <div className="bg-white text-black p-8">
      ...
      <div>
        <SessionNetExposureTableUser matchData={matchData} />
      </div>
    </div>
  );
};

export default SessionNetExposureViewUser;
