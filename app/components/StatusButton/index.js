    ...
    <>
      ...
      <div className="flex items-center gap-2 relative w-full ">
        <div className="w-[45px] flex flex-col justify-center grow relative z-0 text-center min-h-[42px] cursor-pointer border-2 hover:border-[#d44a58] border-[rgb(255,181,189)]  bg-[rgb(255,181,189)] mx-[0.15em] my-0 px-[0.5em] py-[0.12em]">
          <div className="text-[13px] text-[rgb(31,31,31)] text-center leading-[17px] font-semibold mb-[0.1em]"></div>
          <div className="text-[10px] text-center overflow-hidden whitespace-nowrap leading-[17px] text-ellipsis w-full text-[rgb(36,38,41)]"></div>
        </div>
        ...
        <div className="absolute top-0 left-0 w-full h-full z-10 bg-[rgba(0,0,0,0.5)] grid place-content-center font-semibold text-white text-16">
          {status}
        </div>
      </div>
    </>
